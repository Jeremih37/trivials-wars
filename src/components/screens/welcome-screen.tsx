...
import { FUN_FACTS, type FunFact } from "@/lib/facts-data"
...
export function WelcomeScreen() {
  ...
  // Se genera una sola vez al montar. Cada vez que se agota (idx vuelve a 0),
  // se vuelve a barajar para no repetir la misma secuencia.
    ...
    const t = setInterval(() => {
      setFactIdx((i) => {
        ...
        if (next >= FUN_FACTS.length) {
          // Al completar el ciclo, re-barajamos para una nueva secuencia
 ...
 * Garantiza que cada vez que se llama da una secuencia distinta,
 * para que los datos curiosos aparezcan siempre en orden aleatorio.
 */
