        ...
        {!showGoogleMock ? (
          <>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-3 bg-white text-gray-900 hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <GoogleIcon />
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={loginMut.isPending}
                  className="flex-1 py-3 rounded-xl bg-white text-gray-900 hover:bg-gray-100 transition text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  <GoogleIcon />
